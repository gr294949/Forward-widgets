var WidgetMetadata = {
    ...
    modules: [
        ...
        {
            title: "\u5f71\u7247\u8d28\u91cf\u7c7b",
            description: "\u5f71\u7247\u8d28\u91cf\u7c7b - 12\u4e2a\u7c7b\u578b锛�748,863\u90e8\u5f71\u7247",
            requiresWebView: false,
            functionName: "loadPage",
            cacheDuration: 1800,
            params: [
        ...
        {
            title: "\u89d2\u8272\u4e0e\u8eab\u4efd",
            description: "\u89d2\u8272\u4e0e\u8eab\u4efd - 23\u4e2a\u7c7b\u578b锛�609,543\u90e8\u5f71\u7247",
            requiresWebView: false,
            functionName: "loadPage",
            cacheDuration: 1800,
            params: [
        ...
        {
            title: "\u6027\u884c\u4e3a\u7c7b\u578b",
            description: "\u6027\u884c\u4e3a\u7c7b\u578b - 19\u4e2a\u7c7b\u578b锛�759,620\u90e8\u5f71\u7247",
            requiresWebView: false,
            functionName: "loadPage",
            cacheDuration: 1800,
            params: [
        ...
        {
            title: "\u60c5\u8282\u4e0e\u4e3b\u9898",
            description: "\u60c5\u8282\u4e0e\u4e3b\u9898 - 15\u4e2a\u7c7b\u578b锛�363,926\u90e8\u5f71\u7247",
            requiresWebView: false,
            functionName: "loadPage",
            cacheDuration: 1800,
            params: [
        ...
        {
            title: "\u7279\u6b8a\u73a9\u6cd5\u7c7b",
            description: "\u7279\u6b8a\u73a9\u6cd5 - 9\u4e2a\u7c7b\u578b锛�85,102\u90e8\u5f71\u7247",
            requiresWebView: false,
            functionName: "loadPage",
            cacheDuration: 1800,
            params: [
        ...
        {
            title: "\u8eab\u6750\u7279\u5f81\u7c7b",
            description: "\u8eab\u6750\u7279\u5f81 - 14\u4e2a\u7c7b\u578b锛�234,821\u90e8\u5f71\u7247",
            requiresWebView: false,
            functionName: "loadPage",
            cacheDuration: 1800,
            params: [
                {
                    ...
                    enumOptions: [
                        ...
                        { title: "E\u7f69\u676f\u4ee5\u4e0a\u7684Judai锛圽u9752\u5c11\u5e74锛� (55\u90e8)", value: "https://missav.ai/cn/genres/E%E7%BD%A9%E6%9D%AF%E4%BB%A5%E4%B8%8A%E7%9A%84Judai%EF%BC%88%E9%9D%92%E5%B0%91%E5%B9%B4%EF%BC%89" },
        ...
        {
            title: "\u62cd\u6444\u65b9\u5f0f\u7c7b",
            description: "\u62cd\u6444\u65b9\u5f0f - 6\u4e2a\u7c7b\u578b锛�78,894\u90e8\u5f71\u7247",
            requiresWebView: false,
            functionName: "loadPage",
            cacheDuration: 1800,
            params: [
        ...
        {
            title: "\u65f6\u957f\u5408\u96c6\u7c7b",
            description: "\u65f6\u957f\u4e0e\u5408\u96c6 - 3\u4e2a\u7c7b\u578b锛�73,839\u90e8\u5f71\u7247",
            requiresWebView: false,
            functionName: "loadPage",
            cacheDuration: 1800,
            params: [
        ...
        {
            title: "\u670d\u88c5\u9020\u578b\u7c7b",
            description: "\u670d\u88c5\u4e0e\u9020\u578b - 13\u4e2a\u7c7b\u578b锛�657\u90e8\u5f71\u7247",
            requiresWebView: false,
            functionName: "loadPage",
            cacheDuration: 1800,
            params: [
        ...
        {
            title: "\u7279\u6b8a\u9898\u6750\u7c7b",
            description: "\u7279\u6b8a\u9898\u6750 - 25\u4e2a\u7c7b\u578b锛�901\u90e8\u5f71\u7247",
            requiresWebView: false,
            functionName: "loadPage",
            cacheDuration: 1800,
            params: [
...
async function fetchVideoList(url) {
    try {
       ...
        
        ...
        return [createPlaceholderItem("\u8bbf\u95ee\u5931\u8d25锛孿u53ef\u80fd\u5df2\u88ab\u98ce\u63a7")];
    }
}

function createPlaceholderItem(message = "\u5df2\u88ab\u98ce\u63a7锛孿u8bf7\u7a0d\u540e\u91cd\u8bd5") {
    return {
        ...
        duration: 0,
        durationText: "鈿狅笍 \u8bbf\u95ee\u53d7\u9650",
        previewUrl: "",
        videoUrl: "",
        link: "",
        description: "馃敀 " + message + "\n\n馃挕 \u53ef\u80fd\u7684\u89e3\u51b3\u65b9\u6848锛歕n鈥� \u7b49\u5f85\u4e00\u6bb5\u65f6\u95f4\u540e\u91cd\u65b0\u5c1d\u8bd5\n鈥� \u68c0\u67e5\u7f51\u7edc\u8fde\u63a5\n鈥� \u66f4\u6362\u7f51\u7edc\u73af\u5883\n鈥� \u7a0d\u540e\u518d\u8bd5",
        playerType: "none"
    };
}
